...
from item_little_chartwidget import littleChartWidget


class psqWindow(BaseChildWindow):
    def __init__(self,title="文本编辑",callback=None, parent=None, id="", width=600, height=300):
        ...
        self.id = id
        # 文本编辑框（初始为只读）
        self.text_edit = littleChartWidget(self,self.id)
